...
/** List all categories ordered alphabetically to populate filter controls. */
...
/** List all publishers ordered alphabetically to populate filter controls. */
...
/** All matching games ordered by title, optionally filtered by category and/or publisher. */
